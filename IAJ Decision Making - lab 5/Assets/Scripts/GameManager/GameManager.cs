...
namespace Assets.Scripts.GameManager
{
    public class GameManager : MonoBehaviour
    {
        ...
        {
            Debug.Log("1 - " + enemy != null);
            Debug.Log("2 - " + enemy.activeSelf);
            Debug.Log("3 - " + InFireballRange(enemy));
            Debug.Log("4 - " + (this.characterData.Mana >= 5));
            if (enemy != null && enemy.activeSelf && InFireballRange(enemy) && this.characterData.Mana >= 5)
            {
                ...
                Debug.Log("Entrei no range fireball");
            }
        }
        ...
        public void GetManaPotion(GameObject manaPotion)
        {
            ...
            {
                Debug.Log("Entrei no range manapotion");
